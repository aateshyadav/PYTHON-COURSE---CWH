...
- 🤖 **Automation** — file handling, web scraping, scripting with `Requests` & `Shutil`
- 🧠 **AI-Assisted Coding** — leveraging Cursor AI & GitHub Copilot for productivity
- 🎮 **Projects** — calculators, games, automation scripts, and more
- 🐞 **Debugging & Problem-Solving** — writing clean, efficient, interview-ready code
- ✨ **VidSnapAI** — an AI-powered SaaS project using ElevenLabs, FFmpeg & Python
...
├── 02_control_flow/        # Loops & conditionals
├── 03_functions/           # Functions & scope
...
`Python` `Flask` `Requests` `Shutil` `FFmpeg` `ElevenLabs API` `Git & GitHub` `Cursor AI` `GitHub Copilot`
...
- ✅ Share my learning path with others starting out in Python
